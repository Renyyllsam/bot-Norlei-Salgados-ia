export const storeConfig = {
    ...
    categories: [
      { id: 'fritos', name: 'Salgados Fritos', emoji: '🔥', icon: '🔥', description: 'Coxinhas, pastéis, bolinhos e mais' },
      { id: 'congelados', name: 'Salgados Congelados', emoji: '❄️', icon: '❄️', description: 'Prontos para fritar em casa' },
